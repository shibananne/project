var main_coupon = new Vue({
    ...
    mounted() {
        axios.get("/Config/GetAllACouponChild")
            .then((response) => {
                this.dataCop = response.data;
    ...
    methods: {
        async addData() {
            try {
                ...
                formData.append('CouponMain', this.CouponMain);
                formData.append('ContentCop', this.ContentCop);


                await axios.post('/Config/AddCouponChild', formData,
                    {
                        headers: {
        ...
        getItemsByIdColor(id) {
            axios.get(`/Config/getIdCouponChild?id=${id}`)
                .then((response) => {
                    this.id = response.data.id;
                    this.CouponMain = response.data.couponMain;

                    this.ContentCop = response.data.contentCop;
                    return Promise.resolve();
                });
        },
        resetData() {
        ...
        async editData() {
            try {
                ...
                await axios.post('/Config/UpdateCouponChild', formData,
                    {
                        headers: {
                            'Content-Type': 'multipart/form-data'
                        }
        ...
        getItemsByIdDeleteColor(id) {
            axios.get(`/Config/getIdCouponChild/${id}`)
                .then((response) => {
                    this.id = response.data.id;
                    if (this.id != null) {
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                const formData = new FormData();
                                formData.append('ID', this.id);
                                axios.post('/Config/DeleteCouponChild', formData, {
                                    headers: {
