Admin_size = new Vue({
    ...
    computed: {
        computedSlug() {
            return this.generateSlug(this.SubClbName);
        }
    },
    watch: {
        computedSlug(newVal) {
    ...
    methods: {
        ...
        loadSubItems() {
            let currentPage = 0;
            if ($.fn.DataTable.isDataTable('#size_table')) {
                currentPage = $('#size_table').DataTable().page();
            ...
            axios.get("/Config/GetAllSize")
                ...
                .then(() => {
                    const table = $("#size_table").DataTable({
                        'columnDefs': [{
                            'targets': [-1],
                            'orderable': false,
                        }],
        ...
        loadColor() {
            let currentPage = 0;
            if ($.fn.DataTable.isDataTable('#color_table')) {
                currentPage = $('#color_table').DataTable().page();
            ...
            axios.get("/Config/GetAllColor")
                ...
                .then(() => {
                    const table = $("#color_table").DataTable({
                        'columnDefs': [{
                            'targets': [-1],
                            'orderable': false,
                        }],
        ...
        async addCategory() {
            try {
                ...
                formData.append('NameSize', this.NameSize);

                await axios.post('/Config/AddPrSize', formData,
                    {
                        headers: {
        ...
        getItemsById(id) {
            axios.get(`/Config/getIdPrSize?id=${id}`)
                .then((response) => {
                    this.id = response.data.id;
                    this.NameSize = response.data.nameSize;
                    return Promise.resolve();
                });
        },
        resetData() {
        ...
        async editCategory() {
            try {
                ...
                await axios.post('/Config/UpdatePrSize', formData,
                    {
                        headers: {
                            'Content-Type': 'multipart/form-data'
                        }
        ...
        getItemsByIdDelete(id) {
            axios.get(`/Config/getIdPrSize/${id}`)
                .then((response) => {
                    this.id = response.data.id;
                    if (this.id != null) {
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                const formData = new FormData();
                                formData.append('ID', this.id);
                                axios.post('/Config/DeletePrSize', formData, {
                                    headers: {
        ...
        async addColor() {
            try {
                ...
                await axios.post('/Config/AddPrColor', formData,
                    {
                        headers: {
                            'Content-Type': 'multipart/form-data'
                        }
        ...
        getItemsByIdColor(id) {
            axios.get(`/Config/getIdPrColor?id=${id}`)
                .then((response) => {
                    this.idColor = response.data.id;
                    this.NameColor = response.data.nameColor;
                    this.imgColor = response.data.imgColor;
                    return Promise.resolve();
                });
        },
        resetDataColor() {
        ...
        getItemsByIdDeleteColor(id) {
            axios.get(`/Config/getIdPrColor/${id}`)
                .then((response) => {
                    this.idColor = response.data.id;
                    if (this.idColor != null) {
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                const formData = new FormData();
                                formData.append('ID', this.idColor);
                                axios.post('/Config/DeletePrColor', formData, {
                                    headers: {
                                        'Content-Type': 'application/x-www-form-urlencoded'
                                    }
                                }).then(response => {
